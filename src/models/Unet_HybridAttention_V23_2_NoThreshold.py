...
class UNetHybridAttentionV23_2_NoThreshold(nn.Module):
    """
    基于UNetHybridAttentionV23_2, 去掉软阈值；
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV23_2_NoThreshold, self).__init__()
        self.model_name = 'UNetHybridAttentionV23_2_NoThreshold'
