...
class UNetHybridAttentionV6(nn.Module):
    """
    基于UNetHybridAttentionV3，将HybridAttention的两个并行分支拆开，保留下半部分，即GroupNorm的部分；
    """
    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV6, self).__init__()
        self.model_name = 'UNetHybridAttentionV6'
