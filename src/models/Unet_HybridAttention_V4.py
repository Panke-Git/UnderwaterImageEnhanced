...
class UNetHybridAttentionV4(nn.Module):
    """
    使用自己设计的HybridAttention替换Unet第一层的两头，其中HybridAttention中使用了自己设计的GN搭配Conv
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV4, self).__init__()
        self.model_name = 'UNetHybridAttentionV4'
