...
class UNetHybridAttentionV23_2_Ablation3(nn.Module):
    """
    基于UNetHybridAttentionV23_2, 频域分支和归一化流都保留，不使用门控融合
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV23_2_Ablation3, self).__init__()
        self.model_name = 'UNetHybridAttentionV23_2_Ablation3'
