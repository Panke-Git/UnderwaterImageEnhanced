...
class UNetHybridAttentionV23Ablation4(nn.Module):
    """
    基于原始UNetHybridAttentionV23，将HybridAttention的下采样阈值改为0.02，上采样阈值改为0.2；没有记录稀疏性；
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV23Ablation4, self).__init__()
        self.model_name = 'UNetHybridAttentionV23Ablation4'
