...
class UNetHybridAttentionV23_2(nn.Module):
    """
    基于UNetHybridAttentionV23，将HybridAttention前边加入卷积；
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV23_2, self).__init__()
        self.model_name = 'UNetHybridAttentionV23_2'
