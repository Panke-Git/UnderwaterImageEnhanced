...
class UNetHybridAttentionV23_2_Ablation1(nn.Module):
    """
    基于UNetHybridAttentionV23_2,仅保留频域分支
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV23_2_Ablation1, self).__init__()
        self.model_name = 'UNetHybridAttentionV23_2_Ablation1'
