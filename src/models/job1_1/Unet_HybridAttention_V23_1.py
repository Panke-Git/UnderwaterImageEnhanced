...
class UNetHybridAttentionV23_1(nn.Module):
    """
    基于UNetHybridAttentionV23, 去掉alpha;
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV23_1, self).__init__()
        self.model_name = 'UNetHybridAttentionV23_1'
