...
class UNet_CSC_V2(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNet_CSC_V2, self).__init__()
        self.model_name = 'UNet_CSC_V2'
        ...
        self.csc_block4 = CSC_block(base_c * 8)

        # Bottleneck
        self.bottleneck = ConvBlock(base_c * 8, base_c * 16)
        self.csc_block5 = CSC_block(base_c * 16)
    ...
    def forward(self, x):
        ...
        # csc_block
        x4 = self.csc_block4(x4)
        x5 = self.csc_block5(x5)
