"""
    ...
    @Author: Panke
    @FileName: Unet_HybridAttention_V33.py
...
class UNetHybridAttentionV33(nn.Module):
    """
    基于UNetHybridAttentionV23_2，将HybridAttention替换第四层
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV33, self).__init__()
        self.model_name = 'UNetHybridAttentionV33'
    ...
    def forward(self, x):
        ...
        x4 = self.hybrid_attention1(self.pool2(x3))
