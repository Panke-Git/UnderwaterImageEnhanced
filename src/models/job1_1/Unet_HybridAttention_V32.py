"""
    ...
    @Author: Panke
    @FileName: Unet_HybridAttention_V32.py
...
class UNetHybridAttentionV32(nn.Module):
    """
    基于UNetHybridAttentionV23_2，将HybridAttention替换第二层
    """

    def __init__(self, in_channels=3, out_channels=3, base_c=64):
        super(UNetHybridAttentionV32, self).__init__()
        self.model_name = 'UNetHybridAttentionV32'
