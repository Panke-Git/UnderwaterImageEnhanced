...
def train():
    config = Config.load(r'./src/config/config3.yaml')
    # show_banner()
    # 开始时间
    ...
    # ==================================注意修改此值============================================
    # ========================================================================================
    model = models.UNetHybridAttentionV23G(regularization_type='sparsity').to(device)
    model_description = '基于UNetHybridAttentionV25，对G使用稀疏矩阵正则化约束；'
    model_name = 'UNetHybridAttentionV23G_Sparsity'
    ...
    config_file_path = record_utils.save_train_config(record_path,
                                                      ...
                                                      dataset=train_dir,
                                                      regularization='Sparsity Regularization'
                                                      )
