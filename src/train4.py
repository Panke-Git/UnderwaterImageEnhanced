...
def train():
    time.sleep(1)
    config = Config.load(r'/public/home/hnust15874739861/pro/UnderwaterImageEnhanced/src/config/config4.yaml')
    # show_banner()
    # 开始时间
    ...
    # ==================================注意修改此值============================================
    # ========================================================================================
    model = models.UnetHybridAttentionV23_2_Learnable().to(device)
    model_description = '于UNetHybridAttentionV8，使用可学习阈值，输出每个高频子带的软阈值的稀疏性;'
