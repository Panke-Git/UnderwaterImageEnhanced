...
from src.models.Unet_CSC_V2 import UNet_CSC_V2
...
def visual_enhance(root_dir='', img='', model_name='', ):
    ...
    plt.suptitle(f'Visual Enhancement IMG of {model_name}', fontsize=24)
    plt.tight_layout()
